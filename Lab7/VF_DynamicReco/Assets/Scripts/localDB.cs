...
public  class localDB : MonoBehaviour {
    ...
    // Primitive objects
    new ObjectModel { ID = "CubeID",  Type = ObjectModel.TypePrimitive,Name = "Cube", AssetBundleName = "", AssetBundleUri = "", positionX = 0f, positionY = 0f, positionZ = 0f, rotationX = 0f, rotationY = 45f, rotationZ = 45f, scaleX = 0.12f, scaleY = 0.12f, scaleZ = 0.12f },
    new ObjectModel  { ID = "SphereID", Type = ObjectModel.TypePrimitive, Name = "Sphere",AssetBundleName = "", AssetBundleUri = "",  positionX = 0f, positionY = 0f, positionZ = 0f, rotationX = 0f, rotationY = 0f, rotationZ = 0f, scaleX = 0.12f, scaleY = 0.12f, scaleZ = 0.12f },
    new ObjectModel { ID = "CylinderID",  Type = ObjectModel.TypePrimitive, Name = "Cylinder", AssetBundleName = "", AssetBundleUri = "", positionX = 0f, positionY = 0f, positionZ = 0f, rotationX = 0f, rotationY = 0f, rotationZ = 0f, scaleX = 0.12f, scaleY = 0.12f, scaleZ = 0.12f },
    // Prefabs objects in resources folder
    new ObjectModel { ID = "CubeIDInResource",  Type = ObjectModel.TypeLocalPrefab,Name = "MyCube", AssetBundleName = "", AssetBundleUri = "", positionX = 0f, positionY = 0f, positionZ = 0f, rotationX = 0f, rotationY = 45f, rotationZ = 45f, scaleX = 0.12f, scaleY = 0.12f, scaleZ = 0.12f },
    new ObjectModel  { ID = "SphereIDInResource", Type = ObjectModel.TypeLocalPrefab, Name = "MySphere", AssetBundleName = "", AssetBundleUri = "", positionX = 0f, positionY = 0f, positionZ = 0f, rotationX = 0f, rotationY = 0f, rotationZ = 0f, scaleX = 0.12f, scaleY = 0.12f, scaleZ = 0.12f },
    new ObjectModel { ID = "CylinderIDInResource",  Type = ObjectModel.TypeLocalPrefab, Name = "MyCylinder", AssetBundleName = "", AssetBundleUri = "", positionX = 0f, positionY = 0f, positionZ = 0f, rotationX = 0f, rotationY = 0f, rotationZ = 0f, scaleX = 0.12f, scaleY = 0.12f, scaleZ = 0.12f },
    new ObjectModel { ID = "SkeletonIDInResource",  Type = ObjectModel.TypeLocalPrefab, Name = "MySkeleton",AssetBundleName = "", AssetBundleUri = "",  positionX = 0f, positionY = 0f, positionZ = 0f, rotationX = 0f, rotationY = 0f, rotationZ = 0f, scaleX = 1f, scaleY = 1f, scaleZ = 1f },
    // local AssetBundle
    new ObjectModel { ID = "CubeIDInLocalAssetBundle",  Type = ObjectModel.TypeLocalAssetBundle,Name = "MyCube", AssetBundleName = "mycube",  AssetBundleUri = "",positionX = 0f, positionY = 0f, positionZ = 0f, rotationX = 0f, rotationY = 45f, rotationZ = 45f, scaleX = 0.2f, scaleY = 0.2f, scaleZ = 0.2f },
    new ObjectModel  { ID = "SphereIDInLocalAssetBundle", Type = ObjectModel.TypeLocalAssetBundle, Name = "MySphere",AssetBundleName = "mysphere",  AssetBundleUri = "", positionX = 0f, positionY = 0f, positionZ = 0f, rotationX = 0f, rotationY = 0f, rotationZ = 0f, scaleX = 0.12f, scaleY = 0.12f, scaleZ = 0.12f },
    new ObjectModel { ID = "CylinderIDInLocalAssetBundle",  Type = ObjectModel.TypeLocalAssetBundle, Name = "MyCylinder",AssetBundleName = "mycylinder",  AssetBundleUri = "", positionX = 0f, positionY = 0f, positionZ = 0f, rotationX = 0f, rotationY = 0f, rotationZ = 0f, scaleX = 0.12f, scaleY = 0.12f, scaleZ = 0.12f },
    new ObjectModel { ID = "SkeletonIDInLocalAssetBundle",  Type = ObjectModel.TypeLocalAssetBundle, Name = "MySkeleton", AssetBundleName = "myskeleton", AssetBundleUri = "", positionX = 0f, positionY = 0f, positionZ = 0f, rotationX = 0f, rotationY = 0f, rotationZ = 0f, scaleX = 1f, scaleY = 1f, scaleZ = 1f },
    // remote AssetBundle
    new ObjectModel { ID = "CubeIDInRemoteAssetBundle",  Type = ObjectModel.TypeRemoteAssetBundle,Name = "MyCube", AssetBundleName = "mycube", AssetBundleUri = "https://mraiwebapp.azurewebsites.net/AssetBundles/", positionX = 0f, positionY = 0f, positionZ = 0f, rotationX = 0f, rotationY = 0f, rotationZ = 45f, scaleX = 0.12f, scaleY = 0.12f, scaleZ = 0.12f },
    new ObjectModel  { ID = "SphereIDInRemoteAssetBundle", Type = ObjectModel.TypeRemoteAssetBundle, Name = "MySphere",AssetBundleName = "mysphere", AssetBundleUri = "https://mraiwebapp.azurewebsites.net/AssetBundles/",  positionX = 0f, positionY = 0f, positionZ = 0f, rotationX = 0f, rotationY = 0f, rotationZ = 0f, scaleX = 0.12f, scaleY = 0.12f, scaleZ = 0.12f },
