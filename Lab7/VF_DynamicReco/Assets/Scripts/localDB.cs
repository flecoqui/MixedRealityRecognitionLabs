...
public  class localDB : MonoBehaviour {
    ...
    // Primitive objects
    new ObjectModel { ID = "CubeID",  Type = ObjectModel.TypePrimitive,Name = "Cube", AssetBundleName = "", AssetBundleUri = "", positionX = 0f, positionY = 0f, positionZ = 0f, rotationX = 0f, rotationY = 0f, rotationZ = 0f, scaleX = 0.12f, scaleY = 0.12f, scaleZ = 0.12f },
    ...
    // Prefabs objects in resources folder
    new ObjectModel { ID = "CubeIDInResource",  Type = ObjectModel.TypeLocalPrefab,Name = "MyCube", AssetBundleName = "", AssetBundleUri = "", positionX = 0f, positionY = 0f, positionZ = 0f, rotationX = 0f, rotationY = 0f, rotationZ = 0f, scaleX = 0.12f, scaleY = 0.12f, scaleZ = 0.12f },
    ...
    // local AssetBundle
    new ObjectModel { ID = "CubeIDInLocalAssetBundle",  Type = ObjectModel.TypeLocalAssetBundle,Name = "MyCube", AssetBundleName = "mycube",  AssetBundleUri = "",positionX = 0f, positionY = 0f, positionZ = 0f, rotationX = 0f, rotationY = 0f, rotationZ = 0f, scaleX = 0.2f, scaleY = 0.2f, scaleZ = 0.2f },
    ...
    // remote AssetBundle
    new ObjectModel { ID = "CubeIDInRemoteAssetBundle",  Type = ObjectModel.TypeRemoteAssetBundle,Name = "MyCube", AssetBundleName = "mycube", AssetBundleUri = "https://mraiwebapp.azurewebsites.net/AssetBundles/", positionX = 0f, positionY = 0f, positionZ = 0f, rotationX = 0f, rotationY = 0f, rotationZ = 0f, scaleX = 0.12f, scaleY = 0.12f, scaleZ = 0.12f },
